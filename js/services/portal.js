(function() {
    window.initPortalService = function() {
    ...
    function renderPortal(container) {
        ...
        const services = window.KP.getServicesList().filter(s => !s.mayorOnly || window.KP.isMayor(user));

        container.innerHTML = `
            <div class="portal-hero">
                <div class="portal-title">Привет, ${window.KP.displayNick(user)}! 👋</div>
